(function () {
    ...
    const copy = {
        ...
        gr: {
            ...
            intro: 'Η ιστοσελίδα χρησιμοποιεί ένα απαραίτητο cookie για να θυμάται την επιλογή σου. Το Google Analytics παραμένει πλήρως απενεργοποιημένο μέχρι να αποδεχτείς τα cookies αναλυτικών στοιχείων.',
